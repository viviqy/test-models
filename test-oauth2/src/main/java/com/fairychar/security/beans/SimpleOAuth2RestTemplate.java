...
/**
 * Datetime: 2021/3/26 14:42 <br>
 *
 * @author chiyo <br>
 * @since 1.0
 */
public class SimpleOAuth2RestTemplate extends RestTemplate implements OAuth2RestOperations {
    ...
    public SimpleOAuth2RestTemplate(OAuth2ProtectedResourceDetails resource) {
    ...
    public SimpleOAuth2RestTemplate(OAuth2ProtectedResourceDetails resource, OAuth2ClientContext context) {
        super();
        if (resource == null) {
    ...
    protected OAuth2AccessToken acquireAccessToken(OAuth2ClientContext oauth2Context)
        ...
        OAuth2AccessToken unHandleMsg = accessTokenProvider.obtainAccessToken(resource, accessTokenRequest);
        try {
            String maybeToken = (String) unHandleMsg.getAdditionalInformation().get("data");
            TokenDTO tokenDTO = gson.fromJson(maybeToken, TokenDTO.class);
            accessToken = new DefaultOAuth2AccessToken(tokenDTO.getAccessToken());
